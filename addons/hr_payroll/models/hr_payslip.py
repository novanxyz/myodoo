...
class HrPayslip(models.Model):
    ...
    def action_send_email(self):
        res = self.env.user.has_group(
            'hr_payroll.group_hr_payroll_community_manager')
        if res:
            email_values = {
            ...
            mail_template = self.env.ref(
                'hr_payroll.payslip_email_template').sudo()
    ...
    def refund_sheet(self):
        ...
        formview_ref = self.env.ref('hr_payroll.view_hr_payslip_form',
                                    False)
        treeview_ref = self.env.ref('hr_payroll.view_hr_payslip_tree',
                                    False)
        return {
            'name': ("Refund Payslip"),
            'view_mode': 'tree, form',
